...
presentation du musée, plusieurs zones d'intéret, spectacles (?), groupes scolaires qui viennent faire des activités educatives ex fab lab, fondation bombardier qui permet d'éduquer les enfants et fournir des liens culturels
son role au sein du musée, ce qu'il fait exactement: soutien aux usagers en informatiques, maintien des appareils, création de contenu, ex publicité numerique
On a joué a un jeu brise glace Connais tu tes connecteurs ? les appareils sont souvent connectés et branchés a laide de cables
que oeut on faire avec du multimédia, ou est-ce qu'on s'en va? quels sont les domaines connexes: informatique, gestion de projets (comprendre les clients, les demandes non précises souvent, les contraintes) ex si on veut une projection, on la veut sur un mur? un ecran? est-ce qu'il y a du son ou est-ce interactif?
programmation ( il note qu'avec l'intelligence artificielle, il devient plus facile pour nous de générer rapidement du code), production audio-visuel: sources images, sonores, spatialisation, haut parleurs 
éclairage,systèeme eclairage, optique ( de quel facon la lumiere se diffuse ou sera absorbée, ca change la mise en exposition ex temps jour, materiel)
visionnement d'une video des années de 2010, show de vente d'appareils, on a besoin de beaucoup de personnes pour mettre en exposition des dispositifs multimedia ou pour organiser des evenements comme des spectacles, des expositions, 
